...
In the above disassembly, the line +11 shows the address calculation for the struct Message variable, rax is used to store the address. The subsequent lines (+18, +24, +31, +39, +47, +55) store values into specific offsets within the structure.
